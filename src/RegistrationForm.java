...
public class RegistrationForm implements ActionListener {
    ...
    public void setLocationAndSize()
    {
        ...
        back_ground.setBounds(0,0,400,600);
        ...
        if(e.getSource()==registerButton)
        {
            try {
            	 Connection connection =  connector.getConnection();  
                  //Preapared Statement
                PreparedStatement Pstatement=connection.prepareStatement("insert into CUSTOMER(NAME,FATHERNAME,GENDER,EMAIL,PASSWRD,CITY)" + 
                " values(?,?,?,?,?,?,?)");
