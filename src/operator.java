...
public class operator {
	 ...
	 public static boolean isLogin(String _email, String passwrd) {
		 ...
		 try {
             ...
             //Preapared Statement
             PreparedStatement Pstatement=connection.prepareStatement("SELECT NAME,FATHERNAME,PASSWRD,BALANCE,EMAIL  FROM customer WHERE EMAIL=? AND PASSWRD=?");
	 ...
	 public static void  updateStatus(double a, String b) {
		 try {
             ...
             //Preapared Statement
             PreparedStatement Pstatement=connection.prepareStatement("SELECT NAME,PASSWRD,BALANCE,EMAIL  FROM customer WHERE EMAIL=?");
